...
def generate_reuse_toml(repo_root: Path, config: LicenseUtilsConfig) -> str:
    ...
    if len(unexpected_extra_files) > 0:
        ...
        warnings.warn(warning_msg, RuntimeWarning)
    # Generate a consistent header for REUSE.toml
    lines = [
    ...
    # Merge the lines of the REUSE.toml together and return it
    return "\n".join(lines)
